<!-- Start Topbar -->
<div
    class="bg-white dark:bg-darklight dark:border-darkborder flex gap-4 items-center justify-between px-4 h-[60px] border-b border-black/10 detached-topbar relative">
    ...
    <div class="flex items-center gap-4 z-[9]">
        ...
        <div>
            <a href="javascript:void(0);" class="text-black" x-cloak x-show="$store.app.mode === 'light'"
            ...
            <a href="javascript:void(0);" class="text-black dark:text-white/80" x-cloak
        ...
        <div x-data="{
            ...
            class="relative profile h-[60px] flex items-center justify-center">
            ...
            <ul x-ref="panel" x-show="open" x-transition.origin.top.left x-on:click.outside="close($refs.button)" :id="$id('dropdown-button')" style="display: none;" class="absolute z-10 w-40 overflow-hidden bg-white border rounded top-full dark:text-darkmuted dark:border-darkborder dark:bg-darklight ltr:right-0 rtl:left-0 text-black/60 border-black/10">
                <li>
                    <a href="{{ route('profile.show') }}"
                        class="flex items-center gap-2 px-2 py-2.5 dark:hover:bg-white/5 dark:hover:text-white hover:bg-black/5 hover:text-black">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4">
                            <path
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}" x-data>
                        ...
                        <a href="{{ route('logout') }}" @click.prevent="$root.submit();"
                            class="flex items-center gap-2 px-2 py-2.5 dark:hover:bg-white/5 dark:hover:text-white hover:bg-black/5 hover:text-black text-black dark:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4">
                                <path
